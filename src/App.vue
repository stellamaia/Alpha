<template>
 ...
 <b-container>  <img class="main-img" src="./img/ilustracao.png" alt="ilustracao" /></b-container>
      
    
  <div style="height:30px;" >
      <todo class="todo-list"  v-for="t in todos" :key="t.id" @toggle="toggleTodo" @remove="removeTodo" :todo="t" />
  </div>
  </div>
